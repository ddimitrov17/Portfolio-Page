export const myProjects = [
    {
      ...
      desc: 'A social network application that allows users to create, like, comment, edit, and delete posts. Users can also view a catalog of all posts and see detailed views of individual posts. Authentication ensures secure access to features, but guest users can browse the catalog.',
      subdesc:
    ...
    },
    {
      ...
      desc: 'A modern web application that uses AI to curate personalized travel itineraries and provide tailored recommendations for destinations, accommodations, activities, and food—all based on user preferences and budgets.',
      subdesc:
    ...
    {
        title: 'D-Book App',
        desc: 'A full-stack web application for discovering books, managing a personalized reading list, and interacting with reviews. It integrates the Google Books API to provide a vast collection of books.',
        subdesc:
        ...
        logoStyle: {
          ...
          boxShadow: '0px 0px 60px 0px #E573734D',
        },
        tags: [
          { id: 1, name: 'Angular', path: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/angular/angular-original.svg' },
          { id: 2, name: 'Node.js', path: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original.svg' },
          { id: 3, name: 'PostgreSQL', path: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original.svg' },
        ],
      },
